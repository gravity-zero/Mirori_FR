...
class HandDetector :
    def __init__(self, mode=False, maxHand=2, modelComplexity=1, detectCon=0.5 ,trackCon=0.5):
        ...
        self.Hands = self.mpHand.Hands(self.mode, self.maxHand, self.modelComplex, 
                                        self.detectCon, self.trackCon)  # it has detection mode and Tracking mode when we dont have any thing to trackn in goes to detection mode
